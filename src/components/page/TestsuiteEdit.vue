                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        .then((response)=> {
                            ...
                            this.$router.push('/testsuites_list');
                        })
                        .catch(error => {
                ...
                interfaces_by_project_id(pro_id)
                    .then((response)=> {
                        ...
                        response.data.forEach(data => {
                            this.selected_interface_id.forEach(id => {
                                if (id === data.id) {
                        ...
                        this.selected.forEach(data => {
                            let index = this.unselected.indexOf(data)
            ...
            getTestSuiteDetail(){
                get_detail_testsuite(this.current_testsuite_id)
                    .then(response => {
                        ...
                        this.selected_interface_id = JSON.parse(response.data.include)
                    })
                    .catch(error => {
                        this.$message.error('服务器错误');
                    })
